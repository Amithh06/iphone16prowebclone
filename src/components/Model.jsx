...
const Model = () => {
    ...
    useEffect(() => {
      if(size==='large'){
animateWithGsapTimeline(t1,small,largeRotation,'#view1','#view2',{
    transform:'translateX(-100%)',
    duration:2
})
      }
      if(size==='small'){
animateWithGsapTimeline(t1,large,smallRotation,'#view2','#view1',{
            ...
            <div className='screen-max-width'>
                ...
                <div className='flex flex-col items-center mt-5 '>
                    ...
                    <div className='mx-auto w-full  '>
                        <p className='text-sm font-light text-center py-[1vw]  mb-5'> {model.title}</p>
                        <div className='flex-center gap-3  '>
                            <ul className='color-container '>
                                {models.map((item, i) => (
                                    <li key={i} className='w-6 h-6 rounded-full max-2 cursor-pointer ' style={{ backgroundColor: item.color[0] }}
