...
const VideoCarousel = () => {
 ...
 className={`${list.id===2 && 'translate-x-44'}pointer-events-none`}
      ...
      <div className='relative flex-center mt-10 gap-2 pt-10 '>
        <div className='flex-center py-5 px-7 bg-[#171825] backdrop-blur rounded-full gap-2'>
          {
            videoRef.current.map((_, i) => (
              <span key={i}
                ref={(el) => (videoDivRef.current[i] = el)} className='mx-2 w-3 h-3 bg-gray-500 rounded-full relative cursor-pointer '
              >
        ...
        <button className='control-btn flex-center '>
